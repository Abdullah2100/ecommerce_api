...
namespace business.Services.Implement
{
        ...
        : IAuthenticationService
    {
        ...
        public async Task<AuthDto> GenerateToken(Guid id, string email, List<EnUserType> types)
        {
            ...
            claims.AddRange(types.Select(type => new Claim(ClaimTypes.Role, type.ToString())));
            ...
            var refreshToken = await GenerateRefreshToken(id, types.Select(value => value.ToString()).ToList());
